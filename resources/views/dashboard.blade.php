        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            @php
                $stats = [
                    ...
                    ['label' => 'Tersedia', 'value' => number_format($availableProductTypes), 'sub' => 'jenis barang tersedia', 'color' => 'emerald', 'icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z'],
